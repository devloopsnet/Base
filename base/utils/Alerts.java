...
public class Alerts {
     ...
     */
    public void show(String title, String body, boolean isHasPositive, boolean isHasNegative, final Alerts.DialogInterface dialogInterface) {
        try {
            if (dialog != null)
                if (dialog.isShowing())
                    dialog.dismiss();
     ...
     * @param dialogInterface DialogInterface
     */
    public void show(String title, String body, boolean isHasPositive, String positive, boolean isHasNegative, String negative, final Alerts.DialogInterface dialogInterface) {
        try {
            if (dialog != null)
                if (dialog.isShowing())
                    dialog.dismiss();
